...
class Publicacao extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			...
			'pessoas' => array(self::MANY_MANY, 'Pessoa', 'pessoa_publicacao(cod_publicacao, cod_pessoa)', 'select'=>'cod_pessoa, nome'),
		);
	}
	...
	public function defaultScope(){
		return array(
			'condition'=>'publicacao_lang = :lang',
...
/**
	...
	public function beforeValidate(){
		$this->publicacao_lang = Yii::app()->language;
