...
class CategoriaController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			...
			array('allow', // allow authenticated user to perform 'create' and 'update' actions
				'actions'=>array('admin','update', 'create', 'sort', 'addPai'),
				'users'=>array('admin'),
			),
	...
	{
		$categorias = Categoria::model()->findAll(array('order'=>'ordem'));
	...
	public function actionSort()
	{
		...
		{	//Aplica o sort
			...
			foreach($itens as $order => $item){
				...
				$cat = Categoria::model()->findByPk($item);
				$cat->ordem = $order;
				$cat->save(false);
			}
