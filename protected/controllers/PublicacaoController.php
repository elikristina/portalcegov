...
class PublicacaoController extends Controller
{
	 ...
	 */
	public $layout='//layouts/twocolumn_pub';
	...
	public function accessRules()
	{
		return array(
			array('allow',  // allow all users to perform 'index' and 'view' actions
				'actions'=>array('index','view', 'loadDetail','v','p' ),
				'users'=>array('*'),
			),
	...
	public function actionView($id)
	{
		...
		$model = $this->loadModel($id);
		$this->redirect(array('v', 'id'=>$model->cod_publicacao, 'n'=>str_replace(' ', '_',$model->titulo)));
	}
	...
	public function actionIndex($t = null)
	{
		...
		if($t != NULL)
			$this->redirect(array('p', 't'=>$t, 'n'=>str_replace(' ', '_',PublicacaoTipo::model()->findByPk($t)->nome)));
