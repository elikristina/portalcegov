...
class ETinyMce extends CInputWidget
{
   ...
   /**
    * Callback for filebrowsing
    */
   private $file_browser_callback = 'filebrowser';
   ...
   *
    ...
    * @var string
    */
   private $contentCSS = ''; //Yii::app()->request->baseUrl . '/css/main.css';
    ...
    * @return string
    */
   public function getFile_Browser_Callback()
   {
      return $this->file_browser_callback;
   }
   
	public function setFile_Browser_Callback($value)
   {
      $this->file_browser_callback = $value;
   }	
   ...
   protected function makeFullEditor($url='')
   {
      ...
      $this->plugins = array('safari','pagebreak','style','layer','save','advhr','advimage','advlink','spellchecker','inlinepopups','preview','media','searchreplace','contextmenu','paste','directionality','noneditable','nonbreaking','xhtmlxtras');
      ...
      $options['theme_advanced_path_location'] = 'bottom';
		$options['theme_advanced_buttons1'] = "save,pasteword,|,search,replace,|,undo,redo,|spellchecker,|,code,preview, justifyleft,justifycenter,justifyright,justifyfull,|,bullist,numlist,|,outdent,indent,|,hr,media,image,|,link,unlink";
		$options['theme_advanced_buttons2'] = "{$sc}formatselect,|,bold,italic,|,sub,sup{$c1},{$c2}";
		//$options['theme_advanced_buttons3'] = "justifyleft,justifycenter,justifyright,justifyfull,|,bullist,numlist,|,outdent,indent,|,hr,media,image,|,link,unlink";
		//$options['theme_advanced_buttons4'] = "{$c2}tablecontrols";
		$options['theme_advanced_buttons3'] = null;
		$options['theme_advanced_buttons4'] = null;
		$options['theme_advanced_toolbar_location'] = "'top'";
		$options['theme_advanced_toolbar_align'] = "'left'";
   ...
   protected function makeCompressor()
   {
	...
	protected function makeOptions($url='')
	{
      ...
      $options['file_browser_callback'] = $this->file_browser_callback;
