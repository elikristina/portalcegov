...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model,'organizacao'); ?>
		<?php echo $form->textField($model,'organizacao'); ?>
	</div>
	...
	<div class="row">
		<?php echo $form->label($model,'marcador'); ?>
		<?php echo $form->textField($model,'marcador'); ?>
	</div>
