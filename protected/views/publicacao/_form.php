...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row buttons">
		<?php echo CHtml::link('Cancelar', $model->isNewRecord ? array('/publicacao/index') : array('/publicacao/view', 'id'=>$model->cod_publicacao), array('class'=>'btn btn-small btn-warning'));?>
		<?php echo CHtml::submitButton($model->isNewRecord ? 'Adicionar' : 'Salvar', array('id'=>'btnSubmit','class'=>'btn btn-small btn-primary' )); ?>
	</div>
