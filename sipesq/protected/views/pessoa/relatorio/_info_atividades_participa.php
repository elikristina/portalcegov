<br/>
<b>Atividades das quais participa</b>
<div class="view">
	<?php 
	$atividades =$pessoa->getAtividadesParticipaByDate($inicio, $termino, $atividadesParticipaFinalizadas); 
	foreach($atividades as $atividade):
		if($atividade->cod_pessoa != $pessoa->cod_pessoa):?>
			...
			<br />
			<?php if (!empty($atividade->passos) && $atividadesParticipaPassos==1){?>
