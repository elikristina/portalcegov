...
<th>Duração (meses)</th>
<th>Valor</th>
<th><?php echo CHtml::link("<i class='icon icon-plus'></i>",array('/projetoDespesa/add', 'id'=>$verba->cod_verba), array('class'=>'link tip', 'title'=>'Adicionar Despesa'));?></th>
</tr>
</thead>
<tbody>
<?php foreach($verba->despesas as $desp):?>
		<tr>
		<td>
